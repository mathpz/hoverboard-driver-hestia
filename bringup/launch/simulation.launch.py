...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(get_package_share_directory(package_name), 'launch', 'gazebo.launch.py'
    ...
    spawner_entity = Node(
        ...
        arguments=['-topic', 'robot_description', '-entity', 'hestia'],
        output='screen'
    )
