...
def generate_launch_description():
    ...
    package_name='hoverboard_driver' #<--- CHANGE ME
    ...
    controller_params_file = os.path.join(get_package_share_directory(package_name),'config','hoverboard_controllers.yaml')
